...
- THE FRONTEND WILL HAVE BACKEND_URL AS A ENV VARIABLE. THIS BACKEND_URL IS SAME THAT IS RECEIVED FROM BACKEND APP. BECAUSE THE OUTPUT OF THIS URL IS INPUT TO FRONTEND URL. 
